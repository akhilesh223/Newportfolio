          ...
          <Card
            ...
            <motion.div
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
               Creative Full Stack Developer passionate about building modern, responsive, and user-friendly web 
               applications with clean design and efficient functionality.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed">
               Born and raised in India. Passionate about creating modern and user-friendly web applications.
                When I'm not coding, I enjoy learning new technologies, solving programming challenges,
