...
export default function Hero() {
  const words = [
    ...
    "JavaScript Developer & Creator of React.JS",
    "MERN/PERN Stack",
  ...
  const [code] = useState(`
const profile = {
    name: 'Akhilesh Kumar Nishad',
    title: 'Full-Stack Developer |'MERN'|'PERN Stack'| Problem Solver',
    skills: [
        'JavaScript','React.JS', 'Next.JS', 'Redux', 'Express', 'Node.JS',
        'MySQL', 'MongoDB','PostgreSQL', 'Docker', 'AWS', 'CI/CD' 'TypeScript',
        'GraphQL', 'Git','GitHub', 'Linux'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
  ...
  return (
    <>
      <main className="bg-[#020617] text-white min-h-screen">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | MERN/PERN Stack🔧 | Crafting frameworks
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/akhilesh223"
              ...
              <div className="hidden lg:block absolute top-[20rem] Right-[90%] transform -translate-x-1/2 animate-float">
                <div className="px-6 py-2 rounded-lg bg-amber-500/10 backdrop-blur-sm border border-amber-500/20 text-amber-400">
                  <i className="fas fa-lightbulb"></i>&nbsp;&nbsp;MERN
                </div>
              </div>
            </div>
        ...
        <div className="flex justify-center py-10 animate-bounce relative z-20">
